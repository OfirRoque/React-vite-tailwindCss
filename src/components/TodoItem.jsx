...
const TodoItem = ({ todo, handleClick, removeTodo }) => {
  ...
  return (
    <article className=" flex gap-4 py-4 border-b border-b-gray-400 dark:border-gray-600  px-4 ">
      ...
      <p
        className={` grow transition-all duration-1000 dark:text-white ${completed && "line-through text-gray-400  dark:text-gray-600 "}`}
      >
        {title}
      </p>
